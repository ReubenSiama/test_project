		...
		var datatable = $('#invitations').mDatatable({
			...
			columns: [ {
				...
				template: function (row) {
					...
					return '\
						<a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View full brief" data-toggle="modal" data-target="#sitebrief" >\
							<i class="flaticon-visible"></i>\
						</a>\
						<a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View your answers" data-toggle="modal" data-target="#answers1" >\
