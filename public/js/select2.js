...
var Select2 = function() {
    ...
    var demos = function() {
		...
		// match industry
		$('#matchIndustry, #matchIndustry').select2({
            placeholder: "What industries do you specialise in?"
        });
		// match services
		$('#matchServices, #matchServices').select2({
            placeholder: "What services do you offer?"
        });
		// match languages
		$('#matchLanguages, #matchLanguages').select2({
            placeholder: "Languages supported?"
        });
		// match Cities
		$('#matchCity, #matchCity').select2({
            placeholder: "City"
        });
		//industry
