...
var DatatableColumnRenderingDemo = function () {
  ...
  var demo = function() {
    ...
    var datatable = $('#my_agencies').mDatatable({
      // datasource definition
      data: {
        type: 'remote',
        source: {
          read: {
            url: 'data/my-agencies.php',
          }
        },
      ...
      columns: [ {
          ...
          template: function(data) {
            ...
            4 ? 'dropup' : '';
            return '\
						<a href="messages.php" class="m-portlet__nav-link btn m-btn m-btn--hover-primary m-btn--icon m-btn--icon-only m-btn--pill" title="Message">\
